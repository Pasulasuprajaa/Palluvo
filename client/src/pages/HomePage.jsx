...
export default function HomePage({ onNavigate }) {
  ...
  return (
    <div className="space-y-16 sm:space-y-24">
      ...
      <section className="bg-[#F4EFEB] py-16 sm:py-20 border-y border-[#EAE2D7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10">
            ...
            <button
              onClick={() => onNavigate('shop')}
              className="mt-4 md:mt-0 text-xs font-bold uppercase tracking-wider text-[#5B1425] hover:text-[#7E1E34] inline-flex items-center gap-1 group"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {occasionCollections.map((col, idx) => (
              <div
                ...
                className="group relative bg-white rounded-2xl overflow-hidden border border-[#EAE2D7] shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer flex flex-col"
              >
      ...
      <section className="relative bg-[#3F0D19] text-[#FAF7F2] py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <div className="pt-2">
            <button
              ...
              className="px-8 py-3.5 bg-[#C5A059] text-[#1F1A1C] font-bold text-xs uppercase tracking-widest rounded-xl hover:bg-[#E0C07F] transition shadow-xl"
            >
              Discover the Weaves
            </button>
          </div>
