  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[75vh] sm:min-h-[85vh] flex items-center justify-center overflow-hidden bg-[#1F1A1C] text-[#FAF7F2]">
        {/* Background Image with Luminous High-Clarity Luxury Overlay */}
        <div className="absolute inset-0 z-0">
          <picture>
            ...
            <img
              ...
              className="w-full h-full object-cover object-top sm:object-center opacity-90 sm:opacity-95 scale-100 transition-transform duration-1000 ease-out"
            />
          </picture>
          {/* Subtle directional gradient that protects text contrast without darkening the saree & model */}
          <div className="absolute inset-0 bg-gradient-to-t from-[#1F1A1C]/95 via-[#1F1A1C]/50 via-50% to-transparent sm:bg-gradient-to-r sm:from-[#1F1A1C]/95 sm:via-[#1F1A1C]/55 sm:via-45% sm:to-transparent" />
        </div>

        {/* Hero Content */}
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-24 flex flex-col items-start max-w-2xl w-full">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-[#FAF7F2]/15 backdrop-blur-md border border-[#C5A059]/50 text-[#E0C07F] text-[10px] sm:text-xs font-semibold uppercase tracking-widest mb-4 sm:mb-6 animate-fade-in shadow-md">
            <Sparkles className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#C5A059]" />
            <span>The Festive & Bridal Heirloom Edit</span>
          </div>

          <h1 className="font-serif text-3.5xl sm:text-6xl lg:text-7xl font-bold leading-[1.15] sm:leading-[1.1] tracking-tight text-[#FAF7F2] drop-shadow-md animate-slide-up">
            Every drape, <br />
            <span className="italic font-normal gold-gradient-text">a little magic.</span>
          </h1>

          <p className="mt-3.5 sm:mt-6 text-sm sm:text-lg text-[#FAF7F2]/90 leading-relaxed font-sans max-w-lg drop-shadow-sm">
          ...
          <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 w-full sm:w-auto">
            <button
              ...
              className="px-6 sm:px-8 py-3.5 sm:py-4 bg-[#5B1425] hover:bg-[#7E1E34] text-[#FAF7F2] font-bold text-xs uppercase tracking-widest rounded-xl transition-all duration-300 shadow-2xl flex items-center justify-center gap-2.5 border border-[#C5A059]/40 active:scale-95 cursor-pointer focus-visible:ring-2 focus-visible:ring-[#C5A059] focus-visible:outline-none"
            >
            ...
            <button
              ...
              className="px-6 sm:px-8 py-3.5 sm:py-4 bg-[#FAF7F2]/15 hover:bg-[#FAF7F2]/25 backdrop-blur-md text-[#FAF7F2] font-semibold text-xs uppercase tracking-widest rounded-xl transition-all duration-300 border border-white/30 hover:border-[#C5A059] active:scale-95 text-center cursor-pointer focus-visible:ring-2 focus-visible:ring-[#C5A059] focus-visible:outline-none"
            >
              Bridal Edit
            </button>
          </div>
          ...
          {/* Micro Trust Stats */}
          <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-white/20 grid grid-cols-3 gap-3 sm:gap-6 text-left w-full">
            <div>
              <div className="font-serif text-lg sm:text-2xl font-bold text-[#C5A059]">100%</div>
              <div className="text-[10px] sm:text-[11px] text-[#FAF7F2]/80 uppercase tracking-wider mt-0.5">Pure Handloom</div>
            </div>
            <div>
              <div className="font-serif text-lg sm:text-2xl font-bold text-[#C5A059]">15k+</div>
              <div className="text-[10px] sm:text-[11px] text-[#FAF7F2]/80 uppercase tracking-wider mt-0.5">Drapes Loved</div>
            </div>
            <div>
              <div className="font-serif text-lg sm:text-2xl font-bold text-[#C5A059]">4.9 ★</div>
              <div className="text-[10px] sm:text-[11px] text-[#FAF7F2]/80 uppercase tracking-wider mt-0.5">Verified Reviews</div>
            </div>
          </div>
        </div>
      </section>
